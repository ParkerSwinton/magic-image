...
export default function Home() {
  return (
    <main className='flex flex-col items-center justify-between p-12'>
      ...
      <div className='flex flex-col  space-y-6 divide-y divide-zinc-100/20'>
        <div className='space-y-4'>
          <p className='text-zinc-400'>
            <span className='pr-1 font-bold text-zinc-50'>Exterior Only: </span>
            Hand wash and dry with a cleaning of all inner windows. Finished
            with protectant for paint, tires and rims.
          </p>
          <p className='text-zinc-400'>
          ...
          <p className='text-zinc-400'>
            <span className='pr-1 font-bold text-zinc-50'>
              Premium Detail:{' '}
            </span>
